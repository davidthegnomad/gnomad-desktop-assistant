...
#[tauri::command]
pub fn get_chat_store(app: tauri::AppHandle) -> Result<ChatStoreState, String> {
...
#[tauri::command]
pub fn load_chat_session(app: tauri::AppHandle, id: String) -> Result<ChatSession, String> {
    let dir = chats_dir(&app)?;
...
#[tauri::command]
pub fn create_chat_session(app: tauri::AppHandle) -> Result<ChatSession, String> {
    let dir = chats_dir(&app)?;
    let mut store = load_store(&dir)?;
    let id = new_session_id();
    let now = now_secs();
...
#[tauri::command]
pub fn delete_chat_session(app: tauri::AppHandle, id: String) -> Result<ChatSession, String> {
    let dir = chats_dir(&app)?;
    let mut store = load_store(&dir)?;
    let idx = store
        .sessions
...
#[tauri::command]
pub fn set_active_chat_session(app: tauri::AppHandle, id: String) -> Result<(), String> {
    let dir = chats_dir(&app)?;
    let mut store = load_store(&dir)?;
